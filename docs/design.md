...
最終更新: 2026-04-03（Cache Checker 変更サマリー追加）
...
| 2026-04-03 | Cache Checker 変更サマリー追加 | タイトル・説明・画像・テキストの変更箇所をビフォー→アフターで明示表示する「変更サマリー」セクション追加。2カラム比較で変更要素をハイライト（.hl-changed）。変更点の視認性を大幅改善 |
