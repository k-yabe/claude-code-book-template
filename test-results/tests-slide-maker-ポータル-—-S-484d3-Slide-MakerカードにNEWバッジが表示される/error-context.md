...
- Name: tests/slide-maker.spec.js >> ポータル — Slide Makerカード >> ポータルにSlide MakerカードにNEWバッジが表示される
- Location: tests/slide-maker.spec.js:93:3
...
Locator: locator('a.card[href*="slide-maker"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a.card[href*="slide-maker"]')
