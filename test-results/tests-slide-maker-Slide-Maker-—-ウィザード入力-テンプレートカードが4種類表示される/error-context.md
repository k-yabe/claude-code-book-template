...
- Name: tests/slide-maker.spec.js >> Slide Maker — ウィザード入力 >> テンプレートカードが4種類表示される
- Location: tests/slide-maker.spec.js:37:3
...
Call log:
  ...
  - waiting for locator('.template-card')
