...
- Name: tests/slide-maker.spec.js >> Slide Maker — ページ表示 >> ナビバーに「← アプリ一覧へ」リンクが存在する
- Location: tests/slide-maker.spec.js:18:3
...
Locator: locator('.navbar-back')
Expected substring: "アプリ一覧へ"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.navbar-back')
