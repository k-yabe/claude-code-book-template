...
- Name: tests/slide-maker.spec.js >> Slide Maker — ウィザード入力 >> テンプレートを選択するとselectedクラスが付く
- Location: tests/slide-maker.spec.js:42:3
...
Call log:
  - waiting for locator('.template-card[data-val="external-dark"]')
