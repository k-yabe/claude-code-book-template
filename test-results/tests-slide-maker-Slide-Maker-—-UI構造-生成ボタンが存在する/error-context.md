...
- Name: tests/slide-maker.spec.js >> Slide Maker — UI構造 >> 生成ボタンが存在する
- Location: tests/slide-maker.spec.js:75:3
...
Call log:
  ...
  - waiting for locator('#btn-generate')
