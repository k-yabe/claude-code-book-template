...
- **レイアウト配分ルール**（cover/agenda/chapter/closingを除くコンテンツスライド）:
  ...
  - 画像系（text-left-picture-right, text-right-picture-left, content-left-full-picture-right, large-image-right, picture-fullscreen）: **25%以上**
...
- **画像系レイアウトの交互配置**: text-left-picture-right と text-right-picture-left を交互に使い、視覚的リズムを作る
