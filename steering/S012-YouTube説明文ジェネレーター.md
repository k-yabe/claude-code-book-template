...
### やること
- [x] `apps/youtube-desc/index.html` を新規作成（Claude API呼び出し込みの単一ファイル）
- [x] `index.html`（ポータル）にカードを追加
- [x] AKKODiS YouTube説明文ルールに従ったプロンプト設計
...
- [x] 動画タイトル・内容概要を入力してボタンを押すと説明文が生成される
- [x] 生成内容がAKKODiS規定フォーマット（3文冒頭・HPリンク・SNSリンク・5ハッシュタグ）を満たす
